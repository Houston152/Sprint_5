...
email = GenerationData().generation_email()
...
class TestRegistration:
    def test_registration_successful_registration(self, driver):
        ...
        driver.find_element(*Locators.REGISTRATION_PASSWORD_FIELD).send_keys(password)
        ...
        assert WebDriverWait(driver, 5).until(
            EC.text_to_be_present_in_element_attribute(Locators.PROFILE_EMAIL_FIELD, 'value', email))
